...
class TwitterExtractor(Extractor):
    ...
    def run(self):
        ...
        while first > start:
            ...
            self.until = lastMonthEnd.strftime("%Y-%m-%d")
            self.since = lastMonthStart.strftime("%Y-%m-%d")
            first = datetime.strptime(self.since, "%Y-%m-%d")
            print("going to scrape between {} and {}".format(self.since, self.until))
