...
def create_matcher_pattern():
    ...
    :return: list of pattern dictionary
    """
    source = 'reddit'
...
def find_relevelt_posts(data, matcher):
    ...
    """
    match_list = list()
    for i, doc in enumerate(nlp.pipe(data['mention_body'].str.lower(), batch_size=1000)):
        matches = matcher(doc)
...
if __name__ == '__main__':
    ...
    sql = """SELECT * FROM `brightfield-dev.fda_social_raw.social_data_raw` where data_source='twitter'"""
